...
class MultiModalEncoder(nn.Module):
    def __init__(self, node_dim, edge_dim, hidden_dim, latent_dim, n_heads, n_blocks):
        super().__init__()
...
class StructureUnawareDecoder(nn.Module):
    def __init__(self, latent_dim, hidden_dim, n_heads, n_blocks, n_atom_types, n_bond_types, use_trans_encoder=False):
        super().__init__()
